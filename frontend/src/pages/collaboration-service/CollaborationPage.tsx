    ...
    <>
      ...
      <MainContainer>
        <div className="max-w-5xl mx-auto p-6 space-y-6">
          <h1 className="text-2xl font-bold">Practice with john1234</h1>
          <h2 className="text-xl font-semibold">
            Q42: Implementing Stack using Queues - <span className="text-green-600">Easy</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section className="space-y-4">
              <div className="p-4 rounded-md border border-gray-300">
                <h3 className="font-semibold mb-2">Q42: Implementing Stack using Queues</h3>
                <p className="text-sm">
